...
class UWGS_Alt_Text_Tool {
    ...
    private function enqueue_list_view_assets() {
        ...
        $css = '.uwgs-alt-wrap                      { line-height:1.6; }.uwgs-has-alt                       { color:#2e7d32; }.uwgs-alt-blank                     { color:#c62828; font-weight:600; }.uwgs-low-quality                   { color:#856404; font-weight:600; }.uwgs-alt-new-flag                  {
            ...
            }.uwgs-alt-edit-btn:hover            { color:#135e96; }.uwgs-alt-edit-btn:disabled,.uwgs-alt-edit-btn[aria-disabled="true"] { opacity:0.4; cursor:not-allowed; text-decoration:none; }.uwgs-alt-feedback.success          { color:#2e7d32; }.uwgs-alt-feedback.error            { color:#c62828; }.uwgs-alt-editor input[type="text"] { font-size:13px; }.uwgs-alt-guidance {
                margin:6px 0 4px; padding:6px 8px;
                background:#f6f7f7; border-left:3px solid #c3c4c7;
                border-radius:0 2px 2px 0; font-size:11px; color:#646970; line-height:1.5;
            ...
            #uwgs-action-bar.uwgs-action-bar-feedback {
                font-size:12px; min-height:1.2em; line-height:1.5;
            }
        ...
        $data = array(
            ...
            'filterLabel'    => $is_active
                ...
                : __( 'Show alt text issues', 'uwgs-alt-text-tool' ),
            'i18n'           => array(
...
jQuery( function( $ ) {
    ...
    var filterLabel    = data.filterLabel    || 'Show alt text issues';
    var i18n           = data.i18n           || {};
    ...
    function buildActionBar() {
        ...
        if ( isFilterActive ) {
            ...
            if ( goodCount > 0 ) {
                ...
                $btnRow.append( $( '<span>' ).text( i18n.bulkApplyNone || 'No high-quality suggestions available.' ).css( { 'color':'#646970', 'font-size':'12px', 'align-self':'center' } ) );
            }
        }
